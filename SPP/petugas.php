        ...
        <div id="wrapper">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="petugas.php">Data Petugas</a>
                        </div>
                    </div>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 font-weight-bold text-purple">Data Petugas dan Admin SMK Telkom Malang</h1>
                    <p class="mb-4">Berikut adalah data terlengkap petugas dan Admin SMK Telkom Malang</p>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-pink">Data Lengkap Petugas dan Admin</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah_petugas.php" class="btn btn-info btn-icon-split">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-plus"></i>
                                    </span>
                                    <span class="text">Tambah Petugas / Admin</span>
                                </a><hr>
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            ...
                                            // memanggil tabel petugas
                                            $sql = mysqli_query($db, "SELECT * FROM petugas LIMIT $dataAwal, $totalDataHalaman");
                                            $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $r['level']; ?></td>
                                            <td>
                                                <a href="?hapus&id=<?=$r['id_petugas'];?>" onclick="return confirm('Apakah anda yakin untuk menghapusnya ?')" class="btn btn-danger btn-circle btn-sm">
                                                    <i class="fas fa-trash"></i>
                                                </a> 
                                                | 
                                                <a href="edit_petugas.php?id=<?= $r['id_petugas'];?>" class="btn btn-info btn-circle btn-sm">
