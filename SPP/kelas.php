        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-purple sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Pilihan Data</h6>
                            <a class="collapse-item active" href="kelas.php">Data Kelas</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 font-weight-bold text-purple">Data Kelas SMK Telkom Malang</h1>
                    <p class="mb-4">Berikut adalah data terlengkap kelas SMK Telkom Malang</p>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-pink">Data Lengkap Kelas</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah_kelas.php" class="btn btn-info btn-icon-split">
                                ...
                                <tbody class="text-center">
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?hapus&id=<?=$r['id_kelas'];?>" onclick="return confirm('Apakah anda yakin untuk menghapusnya ?')" class="btn btn-danger btn-circle btn-sm">
                                                    <i class="fas fa-trash"></i>
                                                </a> 
                                                | 
                                                <a href="edit_kelas.php?id=<?= $r['id_kelas'];?>" class="btn btn-info btn-circle btn-sm">
