        ...
        <div id="wrapper">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="spp.php">Data SPP</a>
                        </div>
                    </div>
                </li>
                <hr class="sidebar-divider">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 font-weight-bold text-purple">Data SPP SMK Telkom Malang</h1>
                    <p class="mb-4">Berikut adalah data terlengkap SPP SMK Telkom Malang</p>
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah_spp.php" class="btn btn-info btn-icon-split">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?= "Rp. " . $r['nominal']; ?></td>
                                        <td>
                                            <a href="?hapus&id=<?=$r['id_spp'];?>" onclick="return confirm('Apakah anda yakin untuk menghapusnya ?')" class="btn btn-danger btn-circle btn-sm">
                                                <i class="fas fa-trash"></i>
                                            </a> 
                                            | 
                                            <a href="edit_spp.php?id=<?= $r['id_spp'];?>" class="btn btn-info btn-circle btn-sm">
